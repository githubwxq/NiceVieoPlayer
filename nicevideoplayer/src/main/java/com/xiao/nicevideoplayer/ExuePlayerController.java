 ...
 * 仿腾讯视频热点列表页播放器控制器.
 */
public class ExuePlayerController
    ...
    public ExuePlayerController(Context context) {
        super(context);
        mContext = context;
        init();
    }
    ...
    private void init() {
        LayoutInflater.from(mContext).inflate(R.layout.exue_video_palyer_controller, this, true);
